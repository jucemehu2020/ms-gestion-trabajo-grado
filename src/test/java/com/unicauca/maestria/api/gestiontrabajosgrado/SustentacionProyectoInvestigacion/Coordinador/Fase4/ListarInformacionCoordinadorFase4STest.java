...
public class ListarInformacionCoordinadorFase4STest {
    ...
    void ListarInformacionCoordinadorFase4STest_Exito() {
        ...
        coordinadorFase4ResponseDto.setLinkEstudioHojaVidaAcademicaGrado(
                sustentacionTrabajoInvestigacionOld.getLinkEstudioHojaVidaAcademicaGrado());
        coordinadorFase4ResponseDto.setNumeroActaFinal(sustentacionTrabajoInvestigacionOld.getNumeroActaFinal());
        coordinadorFase4ResponseDto.setFechaActaFinal(sustentacionTrabajoInvestigacionOld.getFechaActaFinal());

        when(sustentacionProyectoInvestigacionResponseMapper.toCoordinadorFase4Dto(sustentacionTrabajoInvestigacionOld))
