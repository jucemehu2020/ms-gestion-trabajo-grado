...
public class ListarInformacionCoordinadorFase3STest {
        ...
        void ListarInformacionCoordinadorFase2STest_Exito() {
                ...
                coordinadorFase3ResponseDto
                                .setJuradosAceptados(sustentacionTrabajoInvestigacionOld.getJuradosAceptados());
                coordinadorFase3ResponseDto
                                .setNumeroActaConsejo(sustentacionTrabajoInvestigacionOld.getNumeroActaConsejo());
                coordinadorFase3ResponseDto
                                .setFechaActaConsejo(sustentacionTrabajoInvestigacionOld.getFechaActaConsejo());
                coordinadorFase3ResponseDto
                                .setIdJuradoInterno(String
                                                .valueOf(sustentacionTrabajoInvestigacionOld.getIdJuradoInterno()));
                coordinadorFase3ResponseDto
                                .setIdJuradoExterno(String
                                                .valueOf(sustentacionTrabajoInvestigacionOld.getIdJuradoExterno()));

                when(sustentacionProyectoInvestigacionResponseMapper
                                .toCoordinadorFase3Dto(sustentacionTrabajoInvestigacionOld))
