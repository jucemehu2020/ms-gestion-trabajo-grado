...
public class ActualizarInformacionCoordinadorFase1Test {
    ...
    void testActualizarInformacionCoordinadorFase1Test_ActualizacionExitosaModificacionTrue() {
        ...
        envioEmailDto.setMensaje("Solicito comedidamente revisar el examen de valoracion del estudiante Julio Mellizo para aprobacion");
        ...
        solicitudExamenValoracionOld.setConceptoCoordinadorDocumentos(false);
    ...
    void testActualizarInformacionCoordinadorFase1Test_ActualizacionExitosaModificacionFalse() {
        ...
        envioEmailDto.setMensaje("Solicito comedidamente revisar el anteproyecto en el apartado de Introduccion");
        ...
        SolicitudExamenValoracion solicitudExamenValoracionOld = new SolicitudExamenValoracion();
        solicitudExamenValoracionOld.setConceptoCoordinadorDocumentos(true);
        when(solicitudExamenValoracionRepository
                .findById(trabajoGrado.getExamenValoracion().getIdExamenValoracion()))
                .thenReturn(Optional.of(solicitudExamenValoracionOld));
